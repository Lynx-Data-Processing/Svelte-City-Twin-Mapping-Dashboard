...
// @ts-nocheck
	...
	import { getListOfDevicesUnderTenant, getAllEvents } from "../../service/smarter-api";
...
<Navbar title={"USARs Mapping - Kingston"} bind:selectedMenu bind:menuComponents />
