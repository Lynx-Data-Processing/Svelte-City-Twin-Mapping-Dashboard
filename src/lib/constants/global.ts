...
export const OPEN_DATA_KINGSTON_PLANNING_LINE_URL = "https://opendatakingston.cityofkingston.ca/api/records/1.0/search/?dataset=capital-planning-lines&q=&facet=capital_program_line&facet=program_subclass&facet=project_title&facet=project_planning_from&facet=project_planning_to&facet=planned_construction_from&facet=planned_construction_to&facet=construction_completion_from&facet=construction_completion_to";
